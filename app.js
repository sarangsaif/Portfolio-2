function loco() {
      ...
      ScrollTrigger.scrollerProxy("#main", {
          ...
          getBoundingClientRect() {
              const rect = locoScroll.scroll.instance.scroll;
              return { top: rect.y, left: rect.x, width: window.innerWidth, height: window.innerHeight };
          },
  ...
  h1Element.textContent.split("").forEach(function (char) {
      if (char === " ") {
          clutter += " "; // Preserve spaces
      } else {
  ...
  gsap.to("#page2>h1>span", {
      ...
      stagger: 0.02, // Adjust the stagger value for smoother animation
      color: "#fff",
  });
